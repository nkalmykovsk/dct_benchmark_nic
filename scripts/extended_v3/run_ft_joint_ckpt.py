...
Outputs -> results/ft_joint_ckpt/trajectories.csv
"""
...
OUT = Path("/root/dct_benchmark_nic/results/ft_joint_ckpt")
...
def main():
    ...
    jobs = [("bmshj2018-factorized", 6), ("bmshj2018-hyperprior", 6),
            ...
            ("cheng2020-anchor", 6), ("cheng2020-attn", 6),
            ("tcm", 1), ("ftic", 6)]
    for name, q in jobs:
        for lam, guards in ((0.03, True), (0.0, False)):
            t0 = time.time()
            try:
